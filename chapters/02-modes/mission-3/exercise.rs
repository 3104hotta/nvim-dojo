...
// Tasks:
//   1. Comment out lines marked [COMMENT] using Ctrl+v I
//   2. Delete trailing semicolons on lines marked [SEMI] using Ctrl+v $hd
//   3. Replace "debug" with "info" on lines marked [LEVEL] using :%s
...
pub fn setup_tracing() {
    ...
    let fallback_level = "debug";
    let override_level = "debug";
